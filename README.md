...
The buildpack installs Oracle JDK 1.8.0_31 and Maven 3.2.5 by default. The
...
-----
    ...
    -----> Installing JDK... (downloading...) version 1.8.0_31 installed
    -----> Installing Maven... version 3.2.5 installed
